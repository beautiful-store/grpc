...
func (c *streamServiceClient) GetURL(ctx context.Context, in *GetURLRequest, opts ...grpc.CallOption) (StreamService_GetURLClient, error) {
	stream, err := c.cc.NewStream(ctx, &StreamService_ServiceDesc.Streams[0], "/v0.jihyun.StreamService/GetURL", opts...)
	if err != nil {
		return nil, err
	}
...
var StreamService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "v0.jihyun.StreamService",
	...
	Metadata: "v0/jihyun/server.proto",
}
