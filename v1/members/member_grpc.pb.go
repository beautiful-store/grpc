...
type MemberClient interface {
	GetMembers(ctx context.Context, in *MembersGetRequest, opts ...grpc.CallOption) (*MembersGetResponse, error)
}
...
func (c *memberClient) GetMembers(ctx context.Context, in *MembersGetRequest, opts ...grpc.CallOption) (*MembersGetResponse, error) {
	out := new(MembersGetResponse)
	err := c.cc.Invoke(ctx, "/v1.members.Member/GetMembers", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type MemberServer interface {
	GetMembers(context.Context, *MembersGetRequest) (*MembersGetResponse, error)
...
func (UnimplementedMemberServer) GetMembers(context.Context, *MembersGetRequest) (*MembersGetResponse, error) {
...
func _Member_GetMembers_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/v1.members.Member/GetMembers",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MemberServer).GetMembers(ctx, req.(*MembersGetRequest))
	}
...
var Member_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "v1/members/member.proto",
}
